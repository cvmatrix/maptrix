...
public sealed record WayTypeTag : IWayTag
{
    public enum EValue
    {
        ...
        ResidentialRoad,
        /// <summary>
        /// (Vehicle) road that provides access to a building, service station, beach, campsite, industrial estate, business park, etc. <br></br>
        /// <br></br>
        ...
        Track,
        /// <summary>
        /// Generic path used by pedestrians, small vehicles, for animal riding or livestock walking. Not designated for use by two-track vehicles.
        /// </summary>
        Path,
        /// <summary>
